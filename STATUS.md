...
В версии `0.2.7` обновлена иконка приложения: Matrix-дождь теперь находится
внутри OLED-friendly рамки экрана и дополнен защитным щитом; элементы больше не
выходят за границы иконки.
