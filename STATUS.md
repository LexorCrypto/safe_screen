...
В версии `0.3.0` добавлена ручная проверка обновлений через GitHub Releases:
приложение сравнивает текущую версию с latest release и скачивает новый DMG в
Downloads.
...
- В меню приложения и menu-bar item добавлена ручная проверка обновлений.
